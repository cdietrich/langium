...
describe('TextSerializer2 Roundtrip Tests', async () => {
...
describe('TextSerializer2 Union Type Arrays', async () => {
...
describe('TextSerializer2 Fragment Rules', async () => {
 ...
 */
describe('TextSerializer2 BooleanLiteral Pattern Issue', async () => {
 ...
 */
describe('TextSerializer2 Infers Type Collision Issue', async () => {
 ...
 */
describe('TextSerializer2 Union/Alias Rules', async () => {
...
describe('TextSerializer2 serializeValue Hook', () => {
    ...
    let serializer: TextSerializer2;
    ...
    beforeAll(async () => {
        ...
        serializer = new TextSerializer2(services);
